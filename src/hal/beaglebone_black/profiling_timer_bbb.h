...
#ifndef ESE_HAL_BBB_PROFILING_TIMER_H_
#define ESE_HAL_BBB_PROFILING_TIMER_H_
...
bbb_get_clocks_per_second_profiling_timer(void)
{
...
bbb_initialize_profiling_timer(void)
{
...
/**
  ...
  \return timer value
 */
__attribute__( ( always_inline ) ) __STATIC_INLINE void bbb_get_profile_timer(
...
#endif/* ESE_HAL_BBB_PROFILING_TIMER_H_ */
