...
#ifndef ESE_HAL_BBB_UART_H_
#define ESE_HAL_BBB_UART_H_
 ...
 */
CommStatus bbb_uart_initialize(const uint32_t baud);
...
/**
   ...
   \return status of the operation
 */
CommStatus bbb_uart_transmit_byte(const uint8_t byte);
...
/**
   ...
   \return status of the operation
 */
CommStatus bbb_uart_receive_byte(uint8_t *byte);



#endif/* ESE_HAL_BBB_UART_H_ */
